...
from Utils.Create_weight_matrices import (
    Norm_matrix, Recurrence_matrix, RescaleEigenvalues, ReceptiveFields
)


def setup_parameters(tau=1e-3, kernel=None, N=36, M=None, tauPlus=1*1e-3, **kwargs):
    '''This function sets up the parameters for the three-area ring model.
    Params:
    ...
    Wn1 = Norm_matrix(N, std_dev=N/2, gaussian_height=1)
    Wn4 = Norm_matrix(N, std_dev=N/2, gaussian_height=1)
    Wn5 = Norm_matrix(N, std_dev=N/2, gaussian_height=1)
